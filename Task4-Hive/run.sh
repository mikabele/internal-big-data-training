...
hplsql -e $'INCLUDE hive_scripts/fund_db/DDL/procedures/create_monthly-average_fund_procedure.hql; CALL usp_monthly_average_fund('${FULL}$',\''${OPEN_CLOSE}$'\',\''${MARKET}$'\',\''${TASK}$'\');'
